...
try {
    ...
    $clanShortId = strtolower($clanShortId);
    ...
    curl_setopt($ch, CURLOPT_URL, "https://mfrgjyclqnoizevhylbh.supabase.in/rest/v1/clans?select=*&order=level.desc.nullslast&shortName=eq.{$clanShortId}&limit=1");
    ...
    if(count($result) == 0) {
        throw new Error("Clan '$clanShortId' not found");
    }
