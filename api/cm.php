...
try {
    ...
    curl_setopt($ch, CURLOPT_URL, "https://mfrgjyclqnoizevhylbh.supabase.in/rest/v1/clans?select=*&order=level.desc.nullslast&shortName=eq.{$clanShortIdLower}&limit=1");
    ...
    if (count($result) == 0) {
        ...
        curl_setopt($ch, CURLOPT_URL, "https://mfrgjyclqnoizevhylbh.supabase.in/rest/v1/clans?select=*&order=level.desc.nullslast&shortName=eq.{$clanShortIdUpper}&limit=1");
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($ch, CURLOPT_CUSTOMREQUEST, 'GET');
